...
import static com.nnoboa.duchess.data.FlashContract.CONTENT_AUTHORITY;
...
public class FlashProvider extends ContentProvider {
       ...
       int rowDeleted;
        ...
        switch (match){
            ...
            case SET_ID:
                ...
                break;
            case CARDS:
                rowDeleted = db.delete(FlashContract.CardEntry.TABLE_NAME,selection,selectionArgs);
                break;
            case CARD_ID:
                selection = FlashContract.CardEntry._ID+"=?";
                selectionArgs = new String[]{String.valueOf(ContentUris.parseId(uri))};
    ...
    private int updateCards(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        int updateRow = db.update(FlashContract.CardEntry.TABLE_NAME,values,selection,selectionArgs);
    ...
    private int updateSets(Uri uri, ContentValues values, String selection, String[] selectionArgs){
        ...
        int updateRow = db.update(FlashContract.SetEntry.TABLE_NAME,values,selection,selectionArgs);
